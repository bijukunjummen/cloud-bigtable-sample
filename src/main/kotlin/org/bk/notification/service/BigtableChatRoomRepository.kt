...
class BigtableChatRoomRepository(private val bigtableDataClient: BigtableDataClient) :
    ChatRoomRepository {
    ...
    private fun toRoom(row: Row): ChatRoom {
        ...
        val name =
            row.getCells(CHAT_ROOM_DETAILS_FAMILY, NAME_QUALIFIER).first().value.toStringUtf8()
